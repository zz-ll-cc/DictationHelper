...
import cn.edu.hebtu.software.listendemo.credit.task.ExampleAdapter;
...
//        themeSwitch = (TextView) findViewById(R.id.theme_switch);
        ...
        String[] task={"学习10分钟","每日听写"};
        String[] task_name={"今日累计","今日最好成绩"};
        String[] task_content={"15分钟","100分"};
        String[] add_credit={"+5积分","+5积分"};
        ...
        rvToDoList.setAdapter(new ExampleAdapter(this,title));

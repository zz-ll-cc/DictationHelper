...
public class NewWordRecyclerTimeAdapter extends RecyclerView.Adapter {
    ...
    public NewWordRecyclerTimeAdapter(List<NewOrWrongTimeWord> newWordsList, Context context, int layout_item_id, ImageView ivEmpty, RelativeLayout rlEmpty, LinearLayout llHave) {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder viewHolder, int i) {
        ...
        if (newWordsList.size() == 0) {
            ...
            NewWordRecyclerViewAdapter adapter = new NewWordRecyclerViewAdapter(context, words, R.layout.activity_record_neworwrongword_item, ivEmpty, rlEmpty, llHave, timeWord.getTime(),holder.tvCount);

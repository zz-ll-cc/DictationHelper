...
public class ExampleAdapter extends RecyclerView.Adapter<ExampleAdapter.ViewHolder> {
    ...
    public ExampleAdapter(Context context,List<Map<String,String>> title) {
        this.title=title;
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new ViewHolder(layoutInflater.inflate(R.layout.activty_my_credit_task, parent, false));
    }
